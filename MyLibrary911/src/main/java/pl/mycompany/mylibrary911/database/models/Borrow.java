...
/**
 * Bazodanowy model danych klasy Borrow
 * 
 * Borrow generated by hbm2java modified by Aleksander Szepelak
 */
public class Borrow  implements java.io.Serializable {
    ...
    public Borrow(Book book, Reader reader, Date dateOfRental) {
       this.setBook(book);
    ...
    public String toString() {
        if (dateOfReturn.equals(null)) {
            return this.getBook().getBookName() + " wypożyczona przzez " + this.getReader().toString() + "dnia: " + this.getDateOfRental().toString();
        } else {
            return this.getBook().getBookName() + " wypożyczona przzez " + this.getReader().toString() + "dnia: " + this.getDateOfRental().toString() + ", zwrócona dnia " + this.getDateOfReturn().toString();
        }
    }
}
